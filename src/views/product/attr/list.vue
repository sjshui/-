            ...
            <template slot-scope="{row, $index}">
              ...
              <el-popconfirm :title="`确定删除 ${row.attrName} 吗?`" 
                @onConfirm="deleteAttr(row.id)">
                 <HintButton style="margin-left:10px" slot="reference" title="删除属性" type="danger" icon="el-icon-delete" size="mini"></HintButton>
              </el-popconfirm>
            ...
            <template slot-scope="{row, $index}">
              <el-popconfirm :title="`确定删除 ${row.valueName} 吗?`" 
                @onConfirm="attr.attrValueList.splice($index, 1)">
                 <hint-button style="margin-left:10px" slot="reference" title="删除" type="danger" icon="el-icon-delete" size="mini"></hint-button>
              </el-popconfirm>
            </template>
          </el-table-column>
        </el-table>
